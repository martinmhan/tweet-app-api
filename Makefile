...
build-api-gateway:
	make build-proto-api-gateway && go get github.com/martinmhan/tweet-app-api/cmd/api-gateway
run-api-gateway:
...
build-database-access:
	make build-proto-database-access && go get github.com/martinmhan/tweet-app-api/cmd/database-access
run-database-access:
...
build-events-producer:
	make build-proto-events-producer && go get github.com/martinmhan/tweet-app-api/cmd/events-producer
run-database-access:
